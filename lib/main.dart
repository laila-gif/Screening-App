        ...
        builder: (context, languageService, child) {
          return MaterialApp(
            ...
            supportedLocales: const [
              Locale('id'), // Bahasa Indonesia (tanpa country code untuk kompatibilitas)
              Locale('en', 'US'),
            ],
            ...
            localeResolutionCallback: (locale, supportedLocales) {
              // Jika locale yang diminta tidak didukung, gunakan en_US sebagai fallback
              if (locale != null) {
              ...
              // Fallback ke en_US jika locale tidak didukung
