...
class _MeditationPlayerScreenState extends State<MeditationPlayerScreen>
  ...
  Future<void> _saveMeditationSession() async {
    ...
    if (durationMinutes >= 1) {
      ...
      print('Sesi meditasi disimpan: ${widget.meditation['title']} - $durationMinutes menit');
    }
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Selamat! Anda telah menyelesaikan sesi meditasi ${widget.meditation['title']}.',
          ...
          children: [
            ...
            if (sessionStartTime != null && isPlaying)
              Padding(
                ...
                child: Text(
                  'Durasi: ${DateTime.now().difference(sessionStartTime!).inMinutes} menit',
                  style: TextStyle(
                    fontSize: 14,
